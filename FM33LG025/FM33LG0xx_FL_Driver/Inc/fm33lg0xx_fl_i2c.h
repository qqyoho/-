...
#define    FL_I2C_MSP_DATA_RECIVE_BUFF_ONWAY                      (0x0U << I2C_MSPSR_BF_Pos)
#define    FL_I2C_MSP_DATA_RECIVE_BUFF_OVER                       (0x1U << I2C_MSPSR_BF_Pos)
...
/**
  * @brief
  * @rmtoll   MSPCR    SEN    FL_I2C_Master_I2CStop_overStatues
  * @param    I2Cx I2C instance
  * @retval   None  2021.6.3 李勇新增 State of bit (1 or 0). 0为over
  */
__STATIC_INLINE uint32_t FL_I2C_Master_I2CStop_overStatues(I2C_Type *I2Cx)
{
   return (uint32_t)(READ_BIT(I2Cx->MSPCR, I2C_MSPCR_PEN_Msk) == I2C_MSPCR_PEN_Msk);
}
...
/**
  * @brief
  * @rmtoll   MSPCR    SEN    FL_I2C_Master_I2CreStart_overStatues
  * @param    I2Cx I2C instance
  * @retval   None  2021.6.3 李勇新增 State of bit (1 or 0). 0为over
  */
__STATIC_INLINE uint32_t FL_I2C_Master_I2CreStart_overStatues(I2C_Type *I2Cx)
{
   return (uint32_t)(READ_BIT(I2Cx->MSPCR, I2C_MSPCR_RSEN_Msk) == I2C_MSPCR_RSEN_Msk);
}
...
/**
  * @brief
  * @rmtoll   MSPCR    SEN    FL_I2C_Master_I2CStart_overStatues
  * @param    I2Cx I2C instance
  * @retval   None  2021.6.3 李勇新增 State of bit (1 or 0). 0为over
  */
__STATIC_INLINE uint32_t FL_I2C_Master_I2CStart_overStatues(I2C_Type *I2Cx)
{
   return (uint32_t)(READ_BIT(I2Cx->MSPCR, I2C_MSPCR_SEN_Msk) == I2C_MSPCR_SEN_Msk);
}
